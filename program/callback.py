...
🤖 **[تيبثون ميوزك](https://t.me/MUISC_TEBTHON) **
            ...
            [
                [
                    InlineKeyboardButton(
                        "⌯ قناة السورس ⌯",
                        url=f"https://t.me/MUISC_TEBTHON",
                    )
                ],
                [
                    InlineKeyboardButton("⌯ مطور السورس ⌯", url=f"https://t.me/P17_12"),
                    InlineKeyboardButton("⌯ مبرمج السورس ⌯", url=f"https://t.me/I_p14"),
                ],
                [InlineKeyboardButton("⌯ تحديثات السورس ⌯", url=f"https://t.me/P_1_PO")],
...
async def cbguides(_, query: CallbackQuery):
 ...
 ⌯ إذا كانت لديك أسئلة  حول هذا البوت ، فيمكنك إخبارنا من هنا ↤ @P17_12

⌯ قناة سورس تيبثون ميوزك 🎵  @MUISC_TEBTHON
__""",
        reply_markup=InlineKeyboardMarkup(
...
⌯ __قناة سورس تيبثون ميوزك 🎵  @MUISC_TEBTHON  __""",
        reply_markup=InlineKeyboardMarkup(
            [
                [
...
✦┅━╍━╍╍━━╍━━╍━┅✦
⌯ قناة سورس تيبثون ميوزك 🎵  @MUISC_TEBTHON__""",
        reply_markup=InlineKeyboardMarkup(
            [[InlineKeyboardButton("🔙رجوع", callback_data="cbcmds")]]
        ),
    )
