...
🤖 **[Tibethon Music](https://t.me/MUISC_TEBTHON) **
    ...
    keyboard = InlineKeyboardMarkup(
            [
               [
                ...
                [       
                    InlineKeyboardButton(
                        "⌯ Tibethon Music ⌯", url=f"https://t.me/MUISC_TEBTHON"
                    ),
                ],
                [
                    InlineKeyboardButton("⌯ اضافه البوت اللي مجموعتك ⌯", url=f"https://t.me/{BOT_USERNAME}?startgroup=true"),
...
async def help(client: Client, message: Message):
    await message.reply_photo(
        ...
        caption=f"""**⌯ مطورين سورس تيبثون ميوزك 🎵**""",
        reply_markup=InlineKeyboardMarkup(
         [
            [
                InlineKeyboardButton("قناة السورس", url=f"https://t.me/MUISC_TEBTHON"),
            ],
            [
                InlineKeyboardButton("مطور السورس", url=f"https://t.me/P17_12"),
            ],
